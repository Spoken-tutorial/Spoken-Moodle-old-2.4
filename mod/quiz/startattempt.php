...
/* Insert in to TestAttendance */
#spoken db connection
global $USER;
include('spoken-config.php');

$sql = "update events_testattendance set status = 2, mdlattempt_id = ".$eventdata->attemptid.", mdluser_firstname='".$USER->firstname."', mdluser_lastname = '".$USER->lastname."' where mdluser_id = ".$USER->id." and mdlcourse_id = ".$eventdata->courseid." and mdlquiz_id = ".$eventdata->quizid;

#var_dump($sql);
$result = mysql_query($sql);
#die;
$result = mysql_query($sql);
/* Insert in to TestAttendance end */
