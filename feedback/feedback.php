...
?>
	...
	<?php if($_POST):
		...
		$query = "INSERT INTO `workshop_feedback` (`id`, `user_id`, `workshop_code`, `rate_workshop`, `content`, `logical_arrangement`, `clarity`, `understandable`, `included_examples`, `instruction_sheet`, `assignments`, `pace_tutorial`, `useful_thing`, `weakness_duration`, `weakness_narration`, `weakness_understand`, `other_weakness`, `workshop_language`, `info_received`, `if_yes`, `comfortable_learning`, `working_computers`, `audio_quality`, `video_quality`, `orgn_wkshop`, `facil_learning`, `motiv_learning`, `time_mgmt`, `soft_klg`, `prov_expn`, `ans_cln`, `help_lern`, `exec_effly`, `ws_improved`, `recomm_wkshop`, `reason_why`) VALUES (NULL, '".$_POST['user_id']."', '".$_POST['workshop_code']."', '".$_POST['rate_workshop']."', '".$_POST['content']."', '".$_POST['logical_arrangement']."', '".$_POST['clarity']."', '".$_POST['understandable']."', '".$_POST['included_examples']."', '".$_POST['instruction_sheet']."', '".$_POST['assignments']."', '".$_POST['pace_tutorial']."', '".$_POST['useful_thing']."', '".$weakness_duration."', '".$weakness_narration."', '".$weakness_understand."', '".$_POST['other_weakness']."', '".$_POST['workshop_language']."', '".$_POST['info_received']."', '".$_POST['if_yes']."', '".$_POST['comfortable_learning']."', '".$_POST['working_computers']."', '".$_POST['audio_quality']."', '".$_POST['video_quality']."', '".$_POST['orgn_wkshop']."', '".$_POST['facil_learning']."', '".$_POST['motiv_learning']."', '".$_POST['time_mgmt']."', '".$_POST['soft_klg']."', '".$_POST['prov_expn']."', '".$_POST['ans_cln']."', '".$_POST['help_lern']."', '".$_POST['exec_effly']."', '".$_POST['ws_improved']."', '".$_POST['recomm_wkshop']."', '".$_POST['reason_why']."')";
		// print_r($query);
		// echo exit;
		if(mysql_query($query)){
				...
				<td colspan="2">
					<table align="center" border="1" width="100%" cellpadding="2">
						...
						<tr>
							<td>Interesting</td>
							<td align="center">
								<input type="radio" class="understandable required " value="1" name="understandable" id="understandable">
							</td>
							<td align="center">
								<input type="radio" class="understandable" value="2" name="understandable" id="understandable">
							</td>
							<td align="center">
								<input type="radio" class="understandable" value="3" name="understandable" id="understandable">
							</td>
							<td align="center">
								<input type="radio" class="understandable" value="4" name="understandable" id="understandable">
							</td>
							<td align="center">
								<input type="radio" class="understandable" value="5" name="understandable" id="understandable">
							</td>
						</tr>
						<tr>
