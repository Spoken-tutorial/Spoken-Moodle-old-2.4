...
?>
					  	...
					  	success: function(data){
							...
							//	console.log(data);
						  		...
						  		if(output){
						  		     ...
						  		     $('.errorcustom').remove();
						  		     	var foss=output.foss_category.split(",");
						  		     	html_data = '';
						  		     	for (var i=0; i < foss.length; i++)
										{
											html_data += "<option value='"+ foss[i] +"'>" + foss[i] + "</option>";
										}
									 $('#foss').html(html_data);
						  		}else{
	...
	<?php if($_POST):
		...
		$query = "INSERT INTO live_workshop_participants (`id`, pname, workshop_code, foss_category,email,branch,institution, `rate_workshop`,  `rate_workshop_why`, `content`, `logical_arrangement`, `clarity`, `understandable`, `included_examples`, `instruction_sheet`, `assignments`, `pace_tutorial`, `useful_thing`, `weakness_duration`, `weakness_narration`, `weakness_understand`, `other_weakness`, `workshop_language`, `info_received`, `if_yes`, `comfortable_learning`, `working_computers`, `audio_quality`, `video_quality`, `orgn_wkshop`, `facil_learning`, `motiv_learning`, `time_mgmt`, `soft_klg`, `prov_expn`, `ans_cln`, `help_lern`, `exec_effly`, `ws_improved`, `recomm_wkshop`, `reason_why`, `general_comment`) VALUES (NULL, '".$_POST['pname']."', '".$_POST['workshop_code']."', '".$_POST['foss_category']."', '".$_POST['email']."', '".$_POST['branch']."', '".$_POST['institution']."', '".$_POST['rate_workshop']."',  '".$_POST['rate_workshop_why']."','".$_POST['content']."', '".$_POST['logical_arrangement']."', '".$_POST['clarity']."', '".$_POST['understandable']."', '".$_POST['included_examples']."', '".$_POST['instruction_sheet']."', '".$_POST['assignments']."', '".$_POST['pace_tutorial']."', '".mysql_real_escape_string($_POST['useful_thing'])."', '".$weakness_duration."', '".$weakness_narration."', '".$weakness_understand."', '".mysql_real_escape_string($_POST['other_weakness'])."', '".$_POST['workshop_language']."', '".$_POST['info_received']."', '".mysql_real_escape_string($_POST['if_yes'])."', '".$_POST['comfortable_learning']."', '".$_POST['working_computers']."', '".$_POST['audio_quality']."', '".$_POST['video_quality']."', '".$_POST['orgn_wkshop']."', '".$_POST['facil_learning']."', '".$_POST['motiv_learning']."', '".$_POST['time_mgmt']."', '".$_POST['soft_klg']."', '".$_POST['prov_expn']."', '".$_POST['ans_cln']."', '".$_POST['help_lern']."', '".$_POST['exec_effly']."', '".mysql_real_escape_string($_POST['ws_improved'])."', '".$_POST['recomm_wkshop']."', '".mysql_real_escape_string($_POST['reason_why'])."', '".$_POST['general_comment']."')";
	...
	<form method="POST" name="feedbackfrm" id="feedbackfrm" class="feedbackfrm">
		<table cellpadding="7" align="center">
			...
			<tr>
				...
				<td>
					<select name='foss_category' id='foss' >
			...
			<tr>
				...
				<td>
					<input type="text" name="pname" id="pname" class="required pname" />
				</td>
			</tr>
			<tr>
				<td>Email ID</td>
				<td>
					<input type="text" name="email" id="email" class="branch" />
				</td>
			</tr>
			<tr>
				<td>Branch and Year of Study/Area of work</td>
				<td>
					<input type="text" name="branch" id="branch" class="required branch" />
				</td>
			</tr>
			<tr>
				<td>Name of Institution/Organisation</td>
				<td><input type="text" name="institution" id="institution" class="required institution" /></td>
			</tr>
			<tr>
			...
			<tr>
			 ...
			 <tr>
                        ...
                        <tr>
                                <td colspan="2">
                                        <textarea name="rate_workshop_why" id="rate_workshop_why" class="rate_workshop_why" rows="3" cols="80"></textarea>
                                </td>
                        </tr>
...
<tr>
				...
				<td colspan="2">
					<table align="center" border="1" width="100%">
						...
						<tr>
							...
							<td align="center">
								<input type="radio" class="workshop_language required" value="English" name="workshop_language" id="lang_english" checked>
							</td>
							<td align="center">
				...
				<td colspan="2">
					<table align="center" border="1" width="100%" cellpadding="2">
						...
						<tr>
							...
							<td align="center">
								<input type="radio" class="orgn_wkshop " value="1" name="orgn_wkshop" id="orgn_wkshop">
							</td>
							<td align="center">
						...
						<tr>
							...
							<td align="center">
								<input type="radio" class="facil_learning " value="1" name="facil_learning" id="facil_learning">
							</td>
							<td align="center">
						...
						<tr>
							...
							<td align="center">
								<input type="radio" class="motiv_learning" value="1" name="motiv_learning" id="motiv_learning">
							</td>
							<td align="center">
						...
						<tr>
							...
							<td align="center">
								<input type="radio" class="time_mgmt " value="1" name="time_mgmt" id="time_mgmt">
							</td>
							<td align="center">
			...
			<tr>
				<td colspan="2">Would you recommend this workshop, Spoken Tutorial Project and its activities to Regional?</td>
			</tr>
			<tr>
				<td colspan="2">
					<table align="center" border="1" width="100%">
