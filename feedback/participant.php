...
<form class="cmxform" id="commentForm" method="post" action="pr.php">
	<table align="center" border="0" cellpadding="7">
		<tr>
			...
			<td>
			<!-- <input id="academic_code" name="academic_code" size="25" class="required academic_code" value="swayam" readonly='readonly' /> -->
			<select class='academic_code' name="academic_code">
		...
		<tr>
			...
			<td><input id="cinstitutionname" name="institution_name" size="25"  class="required institution_name" value="" /></input></td>
		</tr>
		<tr>
			<td><label for="ccity">City</label><em>*</em></td>
			<td><input id="ccity" name="city" size="25"  class="required city" value="" /></input></td>
		</tr>
		<tr>
